...
Ported 1:1 from Qode ``tree-sitter-queries.ts`` (546 lines).
...
# ---------------------------------------------------------------------------
# Language → query mapping  (Qode lines 532-545)
# ---------------------------------------------------------------------------
